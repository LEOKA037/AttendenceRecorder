...
class SettingsTab(BaseTab):
    ...
    def create_widgets(self):
        ...
        member_frame = ttk.LabelFrame(self, text="Manage Team Members")
        member_frame.pack(side="left", fill="both", expand=True, padx=10, pady=10)
        ...
        status_frame = ttk.LabelFrame(self, text="Manage Attendance Statuses")
        status_frame.pack(side="left", fill="both", expand=True, padx=10, pady=10)
